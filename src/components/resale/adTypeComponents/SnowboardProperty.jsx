    ...
    return (
        <>
            <div className="properties">
                ...
                <IMaskInput mask='000' className="snowboard__input create__resale-input" name="length" placeholder='150' value={fields.length}  onChange={handleInputChange} />
                <div className="create__resale-label">Прогиб</div>
                <input className="snowboard__input create__resale-input" name="deflection" placeholder="Flat" value={fields.deflection} onChange={handleInputChange} />
